...
public class WechatMiniappService {
    ...
    public Map<String, Object> getPhoneNumberByCode(String code) {
        ...
        System.out.println("微信手机号接口响应: " + resp);
        ...
        try {
            ...
            System.out.println("微信接口错误: errcode=" + errCode + ", errmsg=" + errMsg);
            
            // 针对常见错误码提供更友好的错误信息
            String friendlyMsg;
            switch (errCode) {
                case 40029:
                    friendlyMsg = "授权码无效或已过期，请重新获取授权";
                    break;
                case 45011:
                    friendlyMsg = "接口调用频率超限，请稍后重试";
                    break;
                case 40013:
                    friendlyMsg = "AppID无效";
                    break;
                case 41001:
                    friendlyMsg = "access_token缺失或无效";
                    break;
                default:
                    friendlyMsg = "获取手机号失败: " + errMsg + " (错误码: " + errCode + ")";
            }
            ...
            System.out.println("解析微信响应异常: " + e.getMessage());
            throw new RuntimeException("解析手机号响应数据异常: " + e.getMessage(), e);
        }
    }
